...
export const Team: React.FC = () => {
  return (
    <section id="team" className="py-24 bg-coffee-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16">
                <h2 className="text-4xl md:text-5xl font-serif font-bold text-coffee-900 mb-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start">
                    ...
                    <div className="flex-1 pt-4">
                        <h3 className="text-xl font-bold text-coffee-900">Johana Nightfall</h3>
                        <p className="text-accent text-sm font-medium mb-4">Lead Chef</p>
                        
                        <h4 className="text-2xl font-serif font-bold text-coffee-800 mb-4 leading-snug">
                        ...
                        <div className="flex gap-2 mb-6">
                            ...
                            <span className="w-3 h-3 rounded-full bg-coffee-200"></span>
                            <span className="w-3 h-3 rounded-full bg-coffee-200"></span>
                        </div>

                        <button className="text-coffee-900 font-bold text-sm tracking-wide uppercase hover:text-accent transition-colors flex items-center gap-2 group">
                            Learn More 
                ...
                <div className="bg-white p-6 rounded-[2rem] shadow-xl flex flex-col sm:flex-row items-center gap-6 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-coffee-100 rounded-bl-[100%] -z-0"></div>
                    ...
                    <div className="z-10">
                         <h3 className="text-xl font-bold text-coffee-900">Sara Zones</h3>
                         <p className="text-gray-400 text-xs font-medium mb-4">Co-Lead Chef</p>
                         ...
                         <div className="flex gap-2">
                             {[1,2,3].map(i => <div key={i} className="w-2 h-2 bg-coffee-200 rounded-full"></div>)}
                         </div>
                    </div>
                </div>
            </div>
